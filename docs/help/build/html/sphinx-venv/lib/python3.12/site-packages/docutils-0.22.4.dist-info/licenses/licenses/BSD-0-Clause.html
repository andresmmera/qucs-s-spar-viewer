...
<title>Zero-Clause BSD | Qucs-S S-parameter Viewer Documentation</title>
<meta content="Zero-Clause BSD | Qucs-S S-parameter Viewer Documentation" property="og:title"/>
<meta content="Zero-Clause BSD | Qucs-S S-parameter Viewer Documentation" name="twitter:title"/>
...
<div class="mr-1">/</div><span aria-current="page" class="font-medium text-foreground overflow-hidden text-ellipsis whitespace-nowrap">Zero-Clause BSD</span>
</nav>
