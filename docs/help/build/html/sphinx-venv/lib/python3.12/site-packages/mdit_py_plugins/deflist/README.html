...
<head>
  ...
  <meta property="og:title" content="markdown-it-deflist | Qucs-S S-parameter Viewer Documentation" />
  <meta name="twitter:title" content="markdown-it-deflist | Qucs-S S-parameter Viewer Documentation" />
...
<div class="mr-1">/</div><span aria-current="page"
        class="font-medium text-foreground overflow-hidden text-ellipsis whitespace-nowrap">markdown-it-deflist</span>
</nav>
