...
<head>
  ...
  <meta property="og:title" content="Vendoring Policy | Qucs-S S-parameter Viewer Documentation" />
  <meta name="twitter:title" content="Vendoring Policy | Qucs-S S-parameter Viewer Documentation" />
...
<div class="mr-1">/</div><span aria-current="page"
        class="font-medium text-foreground overflow-hidden text-ellipsis whitespace-nowrap">Vendoring Policy</span>
</nav>
