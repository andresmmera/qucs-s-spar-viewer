...
<title>Vendoring Policy | Qucs-S S-parameter Viewer Documentation</title>
<meta content="Vendoring Policy | Qucs-S S-parameter Viewer Documentation" property="og:title"/>
<meta content="Vendoring Policy | Qucs-S S-parameter Viewer Documentation" name="twitter:title"/>
...
<div class="mr-1">/</div><span aria-current="page" class="font-medium text-foreground overflow-hidden text-ellipsis whitespace-nowrap">Vendoring Policy</span>
</nav>
...
<h2>Automatic Vendoring</h2>
<p>Vendoring is automated via the <a class="reference external" href="https://pypi.org/project/vendoring/" rel="nofollow noopener">vendoring<svg fill="currentColor" height="1em" stroke="none" viewbox="0 96 960 960" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M188 868q-11-11-11-28t11-28l436-436H400q-17 0-28.5-11.5T360 336q0-17 11.5-28.5T400 296h320q17 0 28.5 11.5T760 336v320q0 17-11.5 28.5T720 696q-17 0-28.5-11.5T680 656V432L244 868q-11 11-28 11t-28-11Z"></path></svg></a> tool from the content of
...
<ul>
<li><a :data-current="activeSection === '#rationale'" class="reference internal" href="#rationale">Rationale</a></li>
<li><a :data-current="activeSection === '#modifications'" class="reference internal" href="#modifications">Modifications</a></li>
<li><a :data-current="activeSection === '#automatic-vendoring'" class="reference internal" href="#automatic-vendoring">Automatic Vendoring</a></li>
<li><a :data-current="activeSection === '#managing-local-patches'" class="reference internal" href="#managing-local-patches">Managing Local Patches</a></li>
<li><a :data-current="activeSection === '#debundling'" class="reference internal" href="#debundling">Debundling</a></li>
</ul>
</div>
</aside>
</main>
