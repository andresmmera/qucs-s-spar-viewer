...
SwrS11CalculatorDialog::SwrS11CalculatorDialog(QWidget *parent)
    ...
    resultsTable->setHorizontalHeaderLabels(QStringList() << "Parameter" << "Value");
    ...
    for (int i = 0; i < 2; ++i) {
        ...
        resultsTable->item(i, 0)->setFlags(resultsTable->item(i, 0)->flags() & ~Qt::ItemIsEditable);
        resultsTable->item(i, 1)->setFlags(resultsTable->item(i, 1)->flags() & ~Qt::ItemIsEditable);
    }
    ...
    connect(spinVSWR, QOverload<double>::of(&CustomDoubleSpinBox::valueChanged), this,
            &SwrS11CalculatorDialog::on_inputChanged);
    connect(spinS11dB, QOverload<double>::of(&CustomDoubleSpinBox::valueChanged), this,
            &SwrS11CalculatorDialog::on_inputChanged);
    connect(spinGammaMag, QOverload<double>::of(&CustomDoubleSpinBox::valueChanged), this,
            &SwrS11CalculatorDialog::on_inputChanged);
...
void SwrS11CalculatorDialog::updateUIForMode() {
    CalculationMode mode = static_cast<CalculationMode>(comboMode->currentIndex());
